...
private static final String SENHA = "sua senha"; // ALTERE AQUI SUA SENHA
...
JOptionPane.showMessageDialog(this, "Não é possível excluir: pacote está em um pedido!", "Erro", JOptionPane.ERROR_MESSAGE);
...
for (ServicoAdicional s : pedido.getServicos()) {

if (s.getId() == id) {

JOptionPane.showMessageDialog(this, "Não é possível excluir: serviço está em um pedido!", "Erro", JOptionPane.ERROR_MESSAGE);
...
pstmt.setTimestamp(2, new Timestamp(pedido.getData().getTime()));
